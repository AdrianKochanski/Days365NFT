...
contract('Auctioner', accounts => {
    ...
    //     it("START(0) - (BACK(0) / END(0)) - BID(1) - Can not bid for an ended auction", async () => {

    //     });

    //     it("START(0) - BID(1) - BID(2) - WITHDRAW(1) - WITHDRAW(1) - Works only once", async () => {

    //     });

    //     it("START(0) - BID(1) - BID(2) - WITHDRAW(1) - BID(1) Will reset bid amount for bidder1 and sets the new one", async () => {
            
    //     });

    //     it("START(0) - BID(1) - END(*) - WITHDRAW(1) Can not withdraw money after winning auction", async () => {
